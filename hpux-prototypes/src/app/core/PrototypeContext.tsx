        ...
        window.parent.postMessage(
          {
            ...
            ownerName: prototype.config.owner?.name ?? '',
            ownerSlack: prototype.config.owner?.slack ?? '',
            personaName: prototype.config.persona?.name ?? '',
            jiraUrl: prototype.config.jiraUrl ?? '',
            recordingUrl: prototype.config.recordingUrl ?? '',
            designDocUrl: prototype.config.designDocUrl ?? '',
          },
          '*',
        );
      }
        ...
        window.parent.postMessage(
          {
            ...
            ownerName: proto.config.owner?.name ?? '',
            ownerSlack: proto.config.owner?.slack ?? '',
            personaName: proto.config.persona?.name ?? '',
            jiraUrl: proto.config.jiraUrl ?? '',
            recordingUrl: proto.config.recordingUrl ?? '',
            designDocUrl: proto.config.designDocUrl ?? '',
          },
          '*',
        );
      }
