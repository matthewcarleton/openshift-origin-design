  ...
  if (!account) {
    return (
      <PageSection>
        ...
        <Link to="/cost-management-integrated/gcp">Back to Google Cloud</Link>
      </PageSection>
    );
  }
        ...
        <Flex justifyContent={{ default: 'justifyContentSpaceBetween' }} alignItems={{ default: 'alignItemsCenter' }}>
          <FlexItem flex={{ default: 'flex_1' }}>
            <Breadcrumb style={{ paddingTop: 'var(--pf-t--global--spacer--sm)' }}>
              ...
              <BreadcrumbItem to="/cost-management-integrated/gcp" isActive>Google Cloud</BreadcrumbItem>
            </Breadcrumb>
          </FlexItem>
              ...
              <nav aria-label="Back to details">
                <ol style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  <li style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Link to="/cost-management-integrated/gcp">Back to Google Cloud account details</Link>
                  </li>
                </ol>
              </nav>
            </FlexItem>
                  ...
                  <FlexItem>
                    ...
                    >
                      <SelectList>
                        ...
                        <SelectOption value="billing" description="Includes buffer zones (default: 3 days before/after month boundaries) to match your invoice. <Link to='/cost-management-integrated/settings'>Customize in Settings</Link>.">
                          Billing
                        </SelectOption>
                      </SelectList>
                    </Select>
