    ...
    <>
      ...
      <div className="template-page-breadcrumb">
        <Breadcrumb>
          ...
          <BreadcrumbItem isActive>Microsoft Azure</BreadcrumbItem>
        </Breadcrumb>
      </div>
      ...
      <div className="template-page-heading">
        ...
        <Content>
          <p>View and manage Azure cost data, accounts, and integrations.</p>
        </Content>
                  ...
                  <Tr key={account.id}>
                    ...
                    <Td dataLabel="Account names" modifier="nowrap">
                      <Flex alignItems={{ default: 'alignItemsCenter' }} spaceItems={{ default: 'spaceItemsSm' }}>
                        <FlexItem>
                          <div>
                            <Link to={`/cost-management-integrated/azure/breakdown?breakdown_desc=${account.id}&breakdown_title=${encodeURIComponent(account.name)}&group_by[subscription_guid]=${account.id}&id=${account.id}`}>
                              {account.name}
                            </Link>
                            {account.alias && (
