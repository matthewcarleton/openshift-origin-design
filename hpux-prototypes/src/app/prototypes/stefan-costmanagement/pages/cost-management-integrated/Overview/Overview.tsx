      ...
      {activeTabKey === 0 && (
                ...
                <GridItem span={12} xl={4}>
                  <div style={{ padding: 'var(--pf-t--global--spacer--md)' }}>
                    ...
                    <CardTitle style={{ padding: 'var(--pf-t--global--spacer--md)', borderTop: '1px solid var(--pf-t--global--border--color--default)' }}>
                      {topItemsTab === 0 ? (
                        <Link to="/cost-management-integrated/openshift?group_by[project]=*">All projects</Link>
                      ) : (
                        <Link to="/cost-management-integrated/openshift?group_by[cluster]=*">All clusters</Link>
                      )}
                    </CardTitle>
                  </div>
                </GridItem>
          ...
          <GridItem span={12} lg={6} xl={4}>
            <Card isFullHeight>
              ...
              <CardBody>
                <Link to="/cost-management-integrated/optimizations">56 optimizations</Link>
              </CardBody>
            </Card>
          </GridItem>
        </Grid>
