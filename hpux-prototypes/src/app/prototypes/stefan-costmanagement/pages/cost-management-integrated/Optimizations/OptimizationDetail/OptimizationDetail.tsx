    ...
    <>
      ...
      >
        <Breadcrumb style={{ paddingTop: 'var(--pf-t--global--spacer--sm)' }}>
          ...
          <BreadcrumbItem to="/cost-management-integrated/optimizations">Optimizations</BreadcrumbItem>
        </Breadcrumb>
      </PageSection>

      {/* Header Section */}
      <PageSection style={{ paddingBottom: 'var(--pf-t--global--spacer--md)', paddingTop: 'var(--pf-t--global--spacer--md)' }}>
        <Link to="/cost-management-integrated/optimizations" style={{ display: 'inline-flex', alignItems: 'center', marginBottom: 'var(--pf-t--global--spacer--sm)' }}>
