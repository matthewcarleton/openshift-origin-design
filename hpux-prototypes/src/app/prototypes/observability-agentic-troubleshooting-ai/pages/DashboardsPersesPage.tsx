...
export const DashboardsPersesPage: React.FC = () => {
  ...
  // Troubleshooting room (opened by global AI assistant)
  const [showTroubleshootingDashboard, setShowTroubleshootingDashboard] = useState(false);
  const [isGeneratingDashboard, setIsGeneratingDashboard] = useState(false);

  useEffect(() => {
    persesAgenticBridge.setShowTroubleshootingDashboard = setShowTroubleshootingDashboard;
    persesAgenticBridge.setIsGeneratingDashboard = setIsGeneratingDashboard;
    persesAgenticBridge.closeNotificationsDrawer = () => setIsNotificationsDrawerOpen(false);
    return () => {
      persesAgenticBridge.setShowTroubleshootingDashboard = null;
      persesAgenticBridge.setIsGeneratingDashboard = null;
      persesAgenticBridge.closeNotificationsDrawer = null;
    };
  }, []);
                          ...
                          <StackItem key={alert.id}>
                            ...
                            >
                              ...
                              <Button
                                variant="link"
                                isInline
                                onClick={() => agenticGlobalAiApi.startTroubleshootingForAlert?.(alert.name)}
                                style={{ marginTop: '8px' }}
                              >
